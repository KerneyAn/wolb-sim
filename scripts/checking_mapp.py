...
def process_recombinant_genomes(bed_file, filenames):
    ...
    for filename in filenames:
        ...
        l, perc_map_area = calculate_mappable_length(donor_chrom, donor_start, donor_end, mappable_regions)
        insert_data  =  {"insert": (perc_map_area)}
        ...
        l, perc_map_area  = calculate_mappable_length(recipient_chrom, upstream_start, upstream_end, mappable_regions)
        upstream_data = {"up": (perc_map_area)}
        l, perc_map_area = calculate_mappable_length(recipient_chrom, downstream_start, downstream_end, mappable_regions)
        downstream_data = {"down": (perc_map_area)}
        ...
        results.append((filename, insert_data, upstream_data, downstream_data))
